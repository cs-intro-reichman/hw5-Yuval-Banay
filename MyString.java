...
public class MyString {
     ...
     *  subsetOf("c","space") returns false
     *
     * @param str1 - a string
     * @param str2 - a string
    ...
    public static String randomStringOfLetters(int n) {
        String random = "";
        for (int i = 0; i < n; i++) {
            char c = (char) (122 - (int) (Math.random() * 26));
            random += c;
        }
        return random;
    }
